...
class sCTkScrollableFrame(baseui.sCTkScrollableFrameUI, ThemeableWidget):
    def __init__(self, master=None, **kw):
        ...
        theme_defaults = THEME_DEFAULTS["sCTkScrollableFrame"]
...
if __name__ == "__main__":
    ...
    # FIX: Safely discover and route child components to the frame's true inner content container
    ...
    header = sCTkLabelPrimary(target_container, text="Transceiver Channel Frequency Monitor", anchor="w")
    ...
    vfo_input = sCTkEntryPrimary(target_container, placeholder_text="Enter manual calibration offset (MHz)...")
    ...
    sync_btn = sCTkButtonPrimary(target_container, text="Synchronize Active VFO Banks")
