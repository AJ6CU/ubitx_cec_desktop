...
class labelPrimary(baseui.labelPrimaryUI, ThemeableWidget):
    def __init__(self, master=None, **kw):
        #
        #   Defaults for this widget
        #
        theme_defaults = {
            # 📈 Bold title configuration profile matching your sCTk naming conventions
            "font": ("Arial", 18, "bold"),
        ...
        # Run our shared theme logic first to sanitize parameters and merge dictionaries exactly via 2 objects
...
if __name__ == "__main__":
    ...
    widget = labelPrimary(base, text="Primary Configuration Header")
