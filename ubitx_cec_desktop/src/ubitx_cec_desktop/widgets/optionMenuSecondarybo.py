...
#
widget_namespace = "optionMenuSecondary"
widget_classname = "optionMenuSecondary"
builder_namespace = "custom_widgets"
section_name = "Project Widgets"


class optionMenuSecondaryBO(CTkOptionMenuBO):
    class_ = optionMenuSecondary
...
register_widget(
    builder_id, optionMenuSecondaryBO, widget_classname, ("ttk", section_name)
)
